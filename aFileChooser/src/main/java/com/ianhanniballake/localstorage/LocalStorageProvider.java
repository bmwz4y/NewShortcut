...
public class LocalStorageProvider extends DocumentsProvider {
    String TAG = "@LocStoBro";
    public static final String AUTHORITY = "nodomain.yeh.newshortcut.documents";
    /**
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(Root.COLUMN_TITLE, getContext().getString(R.string.storage_title));
