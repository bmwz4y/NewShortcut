...
public class FileListFragment extends ListFragment implements
    ...
    public interface Callbacks {
        ...
        void onFileLongSelected(File file);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getListView().setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            @Override
            public boolean onItemLongClick(AdapterView<?> currentAdapterView, View itemView,
                                           int position, long id) {

                FileListAdapter adapter = (FileListAdapter) currentAdapterView.getAdapter();
                ...
                mListener.onFileLongSelected(file);
                return true;
            }
        });*/
    }
